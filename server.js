...
// Middleware
app.use(cors({
  origin: ['http://localhost:3000', 'http://localhost:3001', 'https://holidaysri.com', 'https://www.holidaysri.com', 'https://holiday-sri-admin-frontend-updated.vercel.app', 'https://holiday-sri-client-frontend-updated.vercel.app'],
  credentials: true,
...
const moneyTransactionRoutes = require('./routes/moneyTransactions');
const companyFinanceRoutes = require('./routes/companyFinance');
...
const customizeTourPackageRoutes = require('./routes/customizeTourPackage');
const customizeEventRequestRoutes = require('./routes/customizeEventRequest');
...
const caregiversTimeCurrencyRoutes = require('./routes/caregiversTimeCurrency');
...
const fashionBeautyClothingRoutes = require('./routes/fashionBeautyClothing');
...
app.use('/api/money-transactions', moneyTransactionRoutes);
...
app.use('/api/customize-tour-package', customizeTourPackageRoutes);
app.use('/api/customize-event-request', customizeEventRequestRoutes);
...
app.use('/api/caregivers-time-currency', caregiversTimeCurrencyRoutes);
...
app.use('/api/fashion-beauty-clothing', fashionBeautyClothingRoutes);
