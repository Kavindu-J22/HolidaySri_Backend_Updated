...
const advertisementSchema = new mongoose.Schema({
  ...
  publishedAdModel: {
    type: String,
    enum: ['TravelBuddy', 'TourGuider', 'LocalTourPackage', 'TravelSafeHelpProfessional', 'RentLandCampingParking', 'CafesRestaurants', 'FoodsBeverages', 'VehicleRentalsHire', 'ProfessionalDrivers', 'VehicleRepairsMechanics', 'EventPlannersCoordinators', 'CreativePhotographers'] // Can be extended for other ad types in the future
  }
}, {
  timestamps: true
});
